import {Body, Controller, Delete, Get, Middleware, Param, Post, Put, Res, UseBefore} from "routing-controllers";
...
export default class PostController {
    ...
    @UseBefore(AuthenticationMiddleware,AuthorMiddleware)
    @Post("/post/:author")
    ...
    @UseBefore(AuthenticationMiddleware,ModeratorMiddleware)
    @Delete("/post/:id")
    ...
    async addComment(@Param('id') id: string, @Param('author') user: string, @Body() commentDto: CommentDto, @Res() res: Response) {
